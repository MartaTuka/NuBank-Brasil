...
""", unsafe_allow_html=True)
    ...
    if tabs == "Financero":
        ...
        with open("Images_negocio/valor_acciones.html", "r", encoding='utf-8') as f:     
            html_data = f.read()
        components.html(html_data, height=450)
        st.markdown("<p class='images-text'>La gráfica representa el valor de las acciones de Nubank. Desde su apertura muestra un comportamiento altamente volátil.", unsafe_allow_html=True)
        st.markdown("<p class='images-text'>Se observa una fase inicial de caída tras la apertura seguida por una recuperación hasta mediados de 2022; Una relativa estabilidad con ligera volatilidad hasta finales de 2022, y una bajada hasta principios de 2024; Finalmente se observa una reciente estabilización en Abril de 2024.", unsafe_allow_html=True)
        st.markdown("<p class='images-text'>Este comportamiento refleja la dinámica del mercado que puede influir en el valor de las acciones de una compañía, incluyendo factores internos y externos que afectan la percepción y el valor de la empresa en el mercado bursátil.", unsafe_allow_html=True)
        
        
        with open("Images_negocio/30dias.html", "r", encoding='utf-8') as f:     
            html_data = f.read()
        components.html(html_data, height=450)
